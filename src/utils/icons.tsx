...
function GithubIcon() {
  return (
    <a
      href="https://www.github.com/JuanjoCieri"
      target="_blank"
    ...
    >
      <svg
        ...
        fill="currentColor"
        stroke-width="2"
        className="ai ai-GithubFill transition-all hover:text-orange-500"
      >
  ...
  return (
    ...
    >
      <svg
        ...
        fill="currentColor"
        stroke-width="2"
        className="ai ai-LinkedinBoxFill transition-all hover:text-orange-500"
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
...
export { LinkedinIcon, GithubIcon, LinkIcon };
