...
export default function LastestProject() {
  return (
    <motion.div
      ...
      className="relative overflow-hidden col-span-4 tablet:col-span-4 laptop:col-span-4 desktop:col-span-2 row-span-2 bg-[#00CC99] rounded-xl flex py-10"
    >
      ...
      <div className="w-1/2">
        <motion.img
          initial={{ y: 300 }}
          animate={{ y: 0 }}
          transition={{ duration: 1.5, type: "spring", delay: 2.5 }}
