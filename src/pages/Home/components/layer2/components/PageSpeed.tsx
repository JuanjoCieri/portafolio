...
export default function PageSpeed() {
  return (
    <div className="bg-blue-400 col-span-4 tablet: laptop: desktop:col-span-1 rounded-xl flex desktop:flex-col tablet:flex-col laptop:flex-col items-center justify-around py-5">
      <div>
      ...
      <div>
        <img src={pageSpeed} className="w-[150px] tablet:w-[300px] laptop:w-[300px] desktop:w-[300px]" />
      </div>
    </div>
  );
}
